...
</nav>`;class M extends w{init(){console.log("Nav component mounted!")}}const T=new M({html:C,variables:{"caret-double-right":p("caret-double-right","w-4 h-4 min-w-[1rem]"),"book-open":p("book-open"),"caret-down":p("caret-down"),"lock-key-open":p("lock-key-open")}}),O=`<main class="flex flex-col container mx-auto max-w-3xl p-4 lg:px-0">
  <header
