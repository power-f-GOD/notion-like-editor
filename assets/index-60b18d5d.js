...
</nav>`;class T extends w{init(){console.log("Nav component mounted!")}}const O=new T({html:C,variables:{"caret-double-right":p("caret-double-right","w-4 h-4 min-w-[1rem]"),"book-open":p("book-open"),"caret-down":p("caret-down"),"lock-key-open":p("lock-key-open")}}),M=`<main class="flex flex-col container mx-auto max-w-3xl p-4 lg:px-0">
  <header
...
</li>`;class R extends w{constructor(e,r,t){super(e);a(this,"caretObserver");a(this,"menu");a(this,"list");a(this,"feedback");a(this,"caretRect",null);a(this,"blocks",[{title:"Text",tag:"p",description:"Plain text or paragraph.",placeholder:"Type '/' for block, ('@' to link docs or people doesn't work for now😌)"},{title:"Heading 1",tag:"h1",description:"Big section heading."},{title:"Heading 2",tag:"h2",description:"Medium section heading."},{title:"Heading 3",tag:"h3",description:"Small section heading."}]);a(this,"moveTextareaCaretToPosition",(e,r)=>{var h;const t=(h=e.childNodes[0])==null?void 0:h.textContent,n=document.createRange(),o=window.getSelection(),l=+((r?t==null?void 0:t.length:e.dataset.offset)||-1),i=l>-1&&l<=((t==null?void 0:t.length)||-1/0);i&&n.setStart(e.childNodes[0],l),n.collapse(i),o.removeAllRanges(),o.addRange(n),i||o==null||o.collapseToEnd(),e.focus()});a(this,"switchContextTextarea",(e,r)=>{var f,g,x;const t=e.currentTarget,n=window.getSelection(),o=n&&(n==null?void 0:n.getRangeAt(0)),l=o==null?void 0:o.getBoundingClientRect(),i=t.getBoundingClientRect(),{previousElementSibling:h,nextElementSibling:u}=t,d=((f=t.textContent)==null?void 0:f.length)||0;if(t.dataset.offset=String((o==null?void 0:o.startOffset)||d-1),r){const k=!d;if((e.key==="ArrowUp"||e.key==="ArrowLeft"||e.key==="Backspace")&&h){const m=(o==null?void 0:o.startOffset)===0;e.key==="Backspace"&&k&&m&&(e.preventDefault(),(g=t.parentNode)==null||g.removeChild(t)),(e.key==="ArrowUp"||m&&o.startOffset===o.endOffset||k)&&(e.preventDefault(),this.moveTextareaCaretToPosition(h,e.key==="Backspace"))}else if((e.key==="ArrowDown"||e.key==="ArrowRight")&&u)((o==null?void 0:o.startOffset)===d||e.key==="ArrowDown")&&(e.preventDefault(),this.moveTextareaCaretToPosition(u));else if(e.key==="Enter"){const m=this.caretObserver.dataset.showmenu==="true";e.preventDefault(),m&&this.removeSlash(t),this.appendTextarea(t,m?(x=this.list.querySelector("button"))==null?void 0:x.dataset:void 0),this.showMenu(!1)}}return{selection:n,range:o,caretRect:l,textareaRect:i,textarea:t}});a(this,"setMenuPosition",e=>{const{range:r,caretRect:t,textarea:n}=this.switchContextTextarea(e),l=n.textContent.slice(Math.max(((r==null?void 0:r.startOffset)||0)-8,0),((r==null?void 0:r.startOffset)||0)+1),i=/\/\s?([^\s]+)?$/.test(l)&&e.key!=="Escape";if(t!=null&&t.y&&!this.caretRect&&(this.caretRect=t),this.caretRect&&i){const h=l.trim().replace(/.*\/(\s?([^\s]+)?)/,"$1"),u=this.caretRect.left||n.offsetParent.offsetLeft||0;this.list.innerHTML="",this.feedback.textContent=h||"...",this.blocks.filter(d=>l==="/"||new RegExp(`${h}`,"i").test(d.title)).forEach(d=>{this.list.insertAdjacentHTML("beforeend",this.preprocess(H,{...d,placeholder:d.placeholder||d.title,"text-t":this.icon("text-t","min-w-[1.75rem] opacity-40")}))}),this.list.childElementCount===0&&(this.list.innerHTML='<p class="p-3">No results.🥲</p>'),this.list.onclick=d=>{const f=d.target;f.tagName==="BUTTON"&&(this.removeSlash(n),this.appendTextarea(n,f.dataset),this.showMenu(!1))},this.caretObserver.style.top=`${this.caretRect.top||0}px`,this.caretObserver.style.left=`${u}px`,this.caretObserver.style.height=`${this.caretRect.height||0}px`,u+336>window.innerWidth?(this.menu.style.transformOrigin=`${window.innerWidth-u}px top`,this.menu.style.left=`${window.innerWidth-(u+336)}px`):(this.menu.style.left="0",this.menu.style.transformOrigin="left top"),this.menu.offsetHeight>window.innerHeight-this.caretObserver.offsetTop-32?(this.menu.style.bottom="100%",this.menu.style.top="unset",this.menu.style.transformOrigin=this.menu.style.transformOrigin.replace("top","bottom")):(this.menu.style.bottom="unset",this.menu.style.top="100%",this.menu.style.transformOrigin=this.menu.style.transformOrigin.replace("bottom","top"))}this.showMenu(i),i||(this.caretRect=null)});a(this,"appendTextarea",(e,r)=>{const t=String(Math.random()).replace("0.","id"),n=this.mainComponent.getTextareaTemplate({id:t,tag:"div",placeholder:this.blocks[0].placeholder,...r}),o=this.query("[data-textareas-container]");e?e.insertAdjacentHTML("afterend",n):o.insertAdjacentHTML("beforeend",n);const l=this.query(`#${t}`);l.addEventListener("keydown",i=>{this.switchContextTextarea(i,!0)}),l.addEventListener("keyup",i=>{i.key==="Enter"?i.preventDefault():this.setMenuPosition(i)}),l.addEventListener("blur",()=>this.caretRect=null),l.focus()});this.template=e,this.mainComponent=r,this.icon=t}init(){console.log("Menu component mounted!"),this.caretObserver=this.query("[data-caret-observer]"),this.menu=this.caretObserver.querySelector("[role='menu']"),this.list=this.menu.querySelector("ul"),this.feedback=this.menu.querySelector("[data-feedback]"),this.appendTextarea(),document.body.addEventListener("click",e=>{this.menu.contains(e.target)||this.showMenu(!1)})}showMenu(e){this.caretObserver.dataset.showmenu=String(e)}removeSlash(e){e.textContent=e.textContent.replace("/"+this.feedback.textContent.replace("...",""),"")}}const B=new R({html:E},v,p);document.querySelector("#app").innerHTML=`
  ${O.render()}
  ${v.render()}
  ${B.render()}
`;
